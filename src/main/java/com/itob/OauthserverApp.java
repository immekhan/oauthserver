...
import com.itob.config.ApplicationProperties;
import com.itob.config.DefaultProfileUtil;
...
public class OauthserverApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(OauthserverApp.class);

    private final Environment env;

    public OauthserverApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes oauthserver.
     * <p>
